...
noisify.py:
    ...
    Input is audio-file, noise-file and noise-percentage
...
if __name__ == '__main__':
    try:
        options, arguments = getopt.getopt(sys.argv[1:], 'm:n:N:p:', ['meta', 'noise_file=', 'noise_name', 'percent'])
    ...
    if meta_filename is not None and noise_filename is not None and noise_name is not None and (0 < noise_percent < 1):
        noisify(meta_filename, noise_filename, noise_name, noise_percent)
    else:
        usage()
